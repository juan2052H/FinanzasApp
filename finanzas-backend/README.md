...
Con Docker disponible, `FlywayPostgresMigrationTest` valida migracion PostgreSQL real desde V3 hasta V6 mediante Testcontainers.
...
- Perfil: `/api/users/me`, `/api/users/me/settings`, `/api/users/me/avatar`.
