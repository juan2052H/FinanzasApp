...
Con Docker disponible, `FlywayPostgresMigrationTest` valida migracion PostgreSQL real desde V3 hasta V7 mediante Testcontainers.
...
- Sesiones activas listables/revocables y eliminacion de cuenta anonimizada con `deleted_at`.
- Preferencias de usuario versionadas en `user_settings`.
