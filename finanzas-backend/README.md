...
Con Docker disponible, `FlywayPostgresMigrationTest` valida migracion PostgreSQL real desde V3 hasta V4 mediante Testcontainers.

## API Principal

Contrato canonico: `src/main/resources/openapi/finanzas-api.yaml`.

- Auth: `/api/auth/register`, `/login`, `/refresh`, `/logout`, `/google`.
