...
| UC-007 | Gestion del hogar | OWNER/ADMIN / miembros | Administrar integrantes | Workspace hogar | 1. Ver miembros. 2. Invitar/remover/cambiar rol. 3. Auditar | Sin permisos 403 | Backend soporta miembros; Swing lista/invita/remueve, cambio de rol pendiente | `WorkspaceAccessServiceTest`, `WorkspaceCollaborationServiceTest`; falta UI E2E |
