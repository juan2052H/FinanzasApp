...
- `.\mvnw.cmd -f finanzas-backend\pom.xml test`: backend, 28 pruebas, 0 fallos, 1 omitida por falta de Docker local.
...
- Colaboracion: `WorkspaceCollaborationServiceTest` cubre invitar, aceptar y rechazo por correo ajeno.
