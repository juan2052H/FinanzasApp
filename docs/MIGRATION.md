...
- `V7__account_deletion.sql`: marca `users.deleted_at` para eliminacion anonimizada de cuenta.
...
La clase `FlywayPostgresMigrationTest` usa Testcontainers y migra una base PostgreSQL real desde V3 hasta V7 cuando Docker esta disponible.
